...
const updates = [
  {
    ...
    details: 'Our team finished the chassis assembly using lightweight carbon fiber. Next, we will integrate the powertrain and electronics. This marks a major milestone in the project timeline.',
  },
  {
    id: 2,
    ...
    details: 'The battery pack underwent rigorous testing for safety, efficiency, and thermal management. All modules performed within expected parameters, ensuring reliable performance for the go-kart.',
  },
      ...
      {selectedUpdate && (
        <Dialog open={true} onOpenChange={() => setSelectedUpdate(null)}>
          <DialogContent className="max-w-xl">
            ...
            />
            <p className="text-base text-muted-foreground">{selectedUpdate.details}</p>
          </DialogContent>
        </Dialog>
      )}
    </section>
