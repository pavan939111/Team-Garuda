        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black font-montserrat leading-tight">
                ...
                <span className="block bg-gradient-to-r from-accent to-accent bg-clip-text text-transparent text-glow">
                  Garuda
                </span>
              </h1>
            ...
            <div className="pt-4">
              <Button 
                ...
                className="group px-8 py-4 text-lg font-semibold rounded-xl text-black bg-gradient-to-r from-accent to-accent shadow-[0_4px_20px_rgba(255,215,0,0.25)] hover:shadow-[0_8px_32px_rgba(255,215,0,0.35)] transition-all duration-300 hover:scale-105 border border-accent/40"
              >
                Explore Our Journey
                <ChevronDown className="ml-2 h-6 w-6 group-hover:translate-y-1 transition-transform text-accent" />
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative w-full h-96 lg:h-[500px] animate-float">
              ...
              <div className="w-full h-full bg-gradient-to-br from-primary/20 via-accent/10 to-primary/30 rounded-2xl shadow-elegant border border-primary/20 flex items-center justify-center">
              ...
              {/* Glowing Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-transparent to-accent/20 rounded-2xl animate-pulse-glow"></div>
            </div>
